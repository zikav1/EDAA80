...
class TestSum(unittest.TestCase):
    def test_empty_list(self):
        """
        Tests that an empty list as a parameter to when_is_spring returns an invalid index: -1
        """
        temp_list = []
        spring_index = weather_functions.when_is_spring(temp_list)
    ...
    def test_zeroes_list(self):
        """
        Tests than a list of only zeroes as a parameter to when_is_spring will return an invalid index: -1
        """
        temp_list = [0]*365
        spring_index = weather_functions.when_is_spring(temp_list)
    ...
    def test_reset_at_zero(self):
        """
        Tests that the counter in when_is_spring is reset when the temperature is 0 degrees
        """
    ...
    def test_reset_at_negative(self):
        """
        Tests that the counter in when_is_spring is reset when the temperature is negative
        """
    ...
    def test_all_months(self):
        """
        Tests that the correct value is returned from when_is_spring for every month
        """
        path = Path(__file__).parent / 'temperatur_data.csv'
